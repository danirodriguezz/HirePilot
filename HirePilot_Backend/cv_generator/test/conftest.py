...
from accounts.models import Education, Project, Skill, UserProfile, WorkExperience
...
def full_user_profile(db):
    ...
    user = User.objects.create_user(
        email='test@example.com', password='password123', first_name='Juan', last_name='Perez'
    )
    ...
    # 6. Proyectos
    proj = Project.objects.create(user=user, title='HirePilot', role='Lead', description='SaaS App')
