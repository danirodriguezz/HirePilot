...
class UserRegistrationSerializer(serializers.ModelSerializer):
    ...
    industry = serializers.ChoiceField(
        choices=UserProfile.Industry.choices, source='profile.industry'
    )
    experience = serializers.ChoiceField(
        choices=UserProfile.ExperienceRange.choices, source='profile.years_of_experience'
    )
...
class UserProfileSerializer(serializers.ModelSerializer):
    years_of_experience_display = serializers.CharField(
        source='get_years_of_experience_display', read_only=True
    )
...
class UserDetailSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = User
        fields = ['id', 'email', 'first_name', 'last_name', 'plan', 'is_verified', 'profile']
