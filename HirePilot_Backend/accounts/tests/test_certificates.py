...
class TestCertificateFlow:
    ...
    def user(self):
        ...
        return User.objects.create_user(
            email='certified@test.com', password='password123', is_verified=True
        )
    ...
    def test_get_own_certificates_only(self, auth_client, user):
        ...
        Certificate.objects.create(
            user=user, name='My Cert', issuing_organization='Org A', issue_date='2023-01-01'
        )
    ...
    def test_update_certificate(self, auth_client, user):
        ...
        cert = Certificate.objects.create(
            user=user, name='Old Name', issuing_organization='Old Org', issue_date='2020-01-01'
        )
    ...
    def test_delete_certificate(self, auth_client, user):
        ...
        cert = Certificate.objects.create(
            user=user, name='To Delete', issuing_organization='Org', issue_date='2020-01-01'
        )
