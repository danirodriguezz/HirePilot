...
from accounts.models import WorkAchievement, WorkExperience
...
class TestWorkExperienceFlow:
    ...
    def user(self):
        ...
        return User.objects.create_user(
            email='dev@test.com', password='password123', is_verified=True
        )
    ...
    def test_get_own_experience_only(self, auth_client, api_client, user):
        ...
        WorkExperience.objects.create(
            user=user, company='My Company', role='Dev', start_date='2022-01-01'
        )

        # 2. Crear experiencia de OTRO usuario
        other_user = User.objects.create_user(email='other@test.com', password='pwd')
        WorkExperience.objects.create(
            user=other_user, company='Other Company', role='CEO', start_date='2022-01-01'
        )
