...
class TestSkillFlow:
    ...
    def user(self):
        ...
        return User.objects.create_user(
            email='talented@test.com', password='password123', is_verified=True
        )
    ...
    def test_create_technical_skill(self, auth_client, user):
        ...
        data = {'name': 'Python', 'skill_type': 'TECHNICAL', 'level': 'EXPERT'}
    ...
    def test_create_soft_skill(self, auth_client):
        ...
        data = {'name': 'Liderazgo', 'skill_type': 'SOFT', 'level': 'ADVANCED'}
    ...
    def test_get_own_skills_only(self, auth_client, user):
        ...
        Skill.objects.create(user=user, name='Django', skill_type='TECHNICAL')

        # 2. Habilidad de OTRO usuario
        other_user = User.objects.create_user(email='other@test.com', password='pwd')
        Skill.objects.create(user=other_user, name='Flask', skill_type='TECHNICAL')
    ...
    def test_update_skill_level(self, auth_client, user):
        ...
        skill = Skill.objects.create(
            user=user, name='React', skill_type='TECHNICAL', level='BEGINNER'
        )
    ...
    def test_delete_skill(self, auth_client, user):
        ...
        skill = Skill.objects.create(user=user, name='Photoshop', skill_type='TECHNICAL')
